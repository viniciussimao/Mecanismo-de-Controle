...
def calcular_delay_jitter(arquivo, output_csv):
...
#    dados['delay'] = (dados['egress_global_timestamp_3'] - dados['ingress_global_timestamp_1']) / 1e3
    ...
    dados[['delay', 'jitter']].to_csv(output_csv, index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('output_csv', type=str, help="Caminho do arquivo CSV de saída")

    args = parser.parse_args()
    
    # Chamar a função com o arquivo especificado e o caminho do arquivo CSV de saída
    resultados = calcular_delay_jitter(args.arquivo, args.output_csv)
